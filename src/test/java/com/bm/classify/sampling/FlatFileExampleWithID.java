 ...
 * @since 15.08.2006
 */
public class FlatFileExampleWithID implements SampleableWithId {
    ...
    public boolean equals(Object obj) {
        ...
        final FlatFileExampleWithID other = (FlatFileExampleWithID) obj;
        if (this.name == null) {
            if (other.name != null) {
                return false;
            }
     ...
     * @since 27.08.2006
     * @return - die id
     * @see com.bm.classify.sampling.SampleableWithId#getID()
     */
    public Long getID() {
        return this.id;
    }
